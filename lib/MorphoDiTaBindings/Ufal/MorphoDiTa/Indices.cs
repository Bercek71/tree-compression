...
public class Indices : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<int>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Indices obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Indices(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public Indices(global::System.Collections.Generic.IEnumerable<int> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (int element in c) {
      this.Add(element);
