...
public class TagsetConverter : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(TagsetConverter obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public virtual void convert(TaggedLemma TaggedLemma) {
    morphodita_csharpPINVOKE.TagsetConverter_convert(swigCPtr, TaggedLemma.getCPtr(TaggedLemma));
