...
public class TreeRePairStrategyDynamicN(ITreeRePairEncoder? encoder = null , int minFrequency = 2, int maxN = 10, int minN = 2) : ICompressionStrategy<IDependencyTreeNode>
{
